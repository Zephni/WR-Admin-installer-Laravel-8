...
if (file_exists(__DIR__.$DirToLaravelApplication.'storage/framework/maintenance.php')) {
    require __DIR__.$DirToLaravelApplication.'storage/framework/maintenance.php';
}
...
require __DIR__.$DirToLaravelApplication.'vendor/autoload.php';
...
$app = require_once __DIR__.$DirToLaravelApplication.'bootstrap/app.php';
