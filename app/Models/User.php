...
class User extends Authenticatable
{
    ...
    public static $userFieldsEdit = [
        ...
        'image'                 => ['type' => 'image', 'path' => 'admin/users', 'previewType' => 'square', 'validation' => 'image|mimes:jpeg,png,jpg,png,gif|max:1024', 'help' => 'Image should be a valid JPG, PNG or GIF, no larger than 1024kb. The image will be croped to square'],
    ...
    {
        $publicPath = '/images/admin/users/'.$this->image;
        $fullPath = str_replace('\\', '/', str_replace('//', '/', public_path($publicPath)));

        if(!is_file($fullPath))
            return '/images/admin/users/default.png';
        else
